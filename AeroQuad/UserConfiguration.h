...
#define AeroQuadMega_Wii    // Arduino Mega with Wii Sensors and AeroQuad Shield v2.x //I THINK WE NEED TO USE THIS ONE BUT IM NOT SURE
//#define ArduCopter          // ArduPilot Mega (APM) with Oilpan Sensor Board
//#define AeroQuadMega_CHR6DM // Clean Arduino Mega with CHR6DM as IMU/heading ref. //COULD HAVE TO USE THIS ONE TOO BUT I THINK IT NEEDS OTHER SENSORS
